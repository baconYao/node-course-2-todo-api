...
describe('DELETE /todos/:id', () => {
  it('should remove a todo', (done) => {
    var hexId = todos[1]._id.toHexString();   //拿第二個測資的ID
  ...
  it('should not remove a todo', (done) => {
    var hexId = todos[0]._id.toHexString();   //拿第二個測資的ID
...
describe('PATCH /todos/:id', () => {
  it('should update the todo', (done) => {
    var hexId = todos[0]._id.toHexString();   //拿第一個測資的ID
    var text = 'This is be the new text';
